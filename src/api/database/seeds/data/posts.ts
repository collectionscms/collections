...
export const posts = [
  ...
  },
  {
    ...
    bodyJson:
      '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"Collections simplifica la entrega de contenido multilingüe con una experiencia de escritura fluida, una potente traducción automática y una API intuitiva."}]}]}',
    bodyHtml:
