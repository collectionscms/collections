...
export const writerUser = 'ea23ce3d-b236-41b8-9696-7b2a6377451f';
...
export const users = [
  ...
  },
  {
    ...
    userProjects: [
      {
        projectId: enProject,
        roleId: projectRoles[enProject].writer,
      },
      {
        projectId: jpProject,
        roleId: projectRoles[jpProject].writer,
      },
    ],
  },
  {
