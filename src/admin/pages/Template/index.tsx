  ...
  return (
    <Grid container spacing={3}>
      <TemplateCard
        ...
        gitHubUrl="https://github.com/collectionscms/nextjs-blog-starter"
        demoUrl="https://collections-nextjs-blog.vercel.app/"
        deployUrl="ps://vercel.com/new/clone?repository-url=https://github.com/collectionscms/nextjs-blog-starter&repository-name=collections-nextjs-blog&env=COLLECTIONS_API_URL,COLLECTIONS_API_KEY&envDescription=Required%20to%20connect%20the%20app%20with%20WordPress&envLink=https://github.com/collectionscms/nextjs-blog-starter"
      />
    </Grid>
  );
};
