...
export const InputMultilineType: React.FC<Props> = (props) => {
  ...
  return (
    <Accordion
      expanded={expanded}
      title={t('field_interface.input_multi_line')}
      description={t('field_interface.input_multi_line_caption')}
      icon={AlignLeftOutlined}
      type="middle"
      handleChange={() => handleChange('inputMultiline')}
    >
      <Stack rowGap={3} component="form" onSubmit={handleSubmit(onSubmit)}>
