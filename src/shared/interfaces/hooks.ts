type IHookActionFunction<Args extends any[] = any[]> = (...args: Args) => Promise<void>;
type IHookFilterFunction<Args extends any[] = any[]> = (...args: Args) => Promise<Args[0]>;
type IHookFilterSyncFunction<Args extends any[] = any[]> = (...args: Args) => Args[0];
